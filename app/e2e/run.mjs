...
const resolved = resolveSuites(requested);
const selected = requested.length ? resolved.selected : defaultSuites;
if (resolved.unknown.length) {
  console.error(`Unknown suite. Available: ${availableSelectors.join(', ')}`);
  process.exit(2);
}
